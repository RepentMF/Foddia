...
func _process(_delta):
	...
	if %UserPrefsController.user_prefs.relaxed_macguffin3_flag && %UserPrefsController.user_prefs.difficulty_dropdown_index == 0:
		queue_free()
	elif %UserPrefsController.user_prefs.foddian_macguffin3_flag && %UserPrefsController.user_prefs.difficulty_dropdown_index == 1:
		queue_free()
	elif %UserPrefsController.user_prefs.permadeath_macguffin3_flag && %UserPrefsController.user_prefs.difficulty_dropdown_index == 2:
		queue_free()
