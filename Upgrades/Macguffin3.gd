...
func _process(delta):
	...
	if user_prefs.relaxed_macguffin3_flag && user_prefs.difficulty_dropdown_index == 0:
		queue_free()
	elif user_prefs.foddian_macguffin3_flag && user_prefs.difficulty_dropdown_index == 1:
		queue_free()
	elif user_prefs.permadeath_macguffin3_flag && user_prefs.difficulty_dropdown_index == 2:
		queue_free()
