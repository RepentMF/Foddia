...
func _ready():
	...
	UI.visible = false
	change_colors()
	if %UserPrefsController.user_prefs.hasSong1 && name == "MP3_1":
		queue_free()
	elif %UserPrefsController.user_prefs.hasSong2 && name == "MP3_2":
		queue_free()
		%TeleportAccess2.visible = true
		%TeleportAccess2.useable = true
	elif %UserPrefsController.user_prefs.hasSong3 && name == "MP3_3":
		queue_free()
		%TeleportAccess3.visible = true
		%TeleportAccess3.useable = true
	elif %UserPrefsController.user_prefs.hasSong4 && name == "MP3_4":
		queue_free()
		%TeleportAccess4.visible = true
		%TeleportAccess4.useable = true
	elif %UserPrefsController.user_prefs.hasSong5 && name == "MP3_5":
		queue_free()
		%TeleportAccess5.visible = true
		%TeleportAccess5.useable = true
	elif %UserPrefsController.user_prefs.hasSong6 && name == "MP3_6":
		queue_free()
		%TeleportAccess6.visible = true
		%TeleportAccess6.useable = true
	elif %UserPrefsController.user_prefs.hasSong7 && name == "MP3_7":
		queue_free()
		%TeleportAccess7.visible = true
		%TeleportAccess7.useable = true
	elif %UserPrefsController.user_prefs.hasSong8 && name == "MP3_8":
		queue_free()
...
func _process(_delta):
	...
	if interacting && Input.is_action_just_released("ui_click"):
		...
		UI.visible = false
		%Player.hasMP3 = true
		%UserPrefsController.user_prefs.hasMP3 = true
		if name == "MP3_1":
			%UserPrefsController.user_prefs.hasSong1 = true
		elif name == "MP3_2":
			%UserPrefsController.user_prefs.hasSong2 = true
		if name == "MP3_3":
			%UserPrefsController.user_prefs.hasSong3 = true
		elif name == "MP3_4":
			%UserPrefsController.user_prefs.hasSong4 = true
		elif name == "MP3_5":
			%UserPrefsController.user_prefs.hasSong5 = true
		elif name == "MP3_6":
			%UserPrefsController.user_prefs.hasSong6 = true
		if name == "MP3_7":
			%UserPrefsController.user_prefs.hasSong7 = true
		elif name == "MP3_8":
			%UserPrefsController.user_prefs.hasSong8 = true
